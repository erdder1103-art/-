...
initializeDatabase().then(() => app.listen(port, '0.0.0.0', () => console.log(`Busan Trip Wallet V8.8.1 running on port ${port}`))).catch(error => { console.error('Database initialization failed:', error); process.exit(1); });
